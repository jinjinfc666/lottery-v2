...
//	private Integer panKou;
	...
	private List<CreditMarket> creditMarkets;
	...
	public List<CreditMarket> getCreditMarkets() {
		return creditMarkets;
	}

	public void setCreditMarkets(List<CreditMarket> creditMarkets) {
		this.creditMarkets = creditMarkets;
	}

	public CreditMarket getCurrentMarket() {
