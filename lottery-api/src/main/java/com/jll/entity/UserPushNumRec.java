 ...
 */
public class UserPushNumRec implements java.io.Serializable {
	/**
	 * 
	 */
	...
	public UserPushNumRec() {
	}

	public UserPushNumRec(String lotteryType, String issueNum, String retNum, Integer state, Date startTime, Date endTime, Long downCounter) {
