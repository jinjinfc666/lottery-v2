 ...
 *
 */
public class SwDsPlayTypeFacadeImpl extends DefaultPlayTypeFacadeImpl {
	
	private Logger logger = Logger.getLogger(SwDsPlayTypeFacadeImpl.class);
	
	protected String playTypeDesc = "ds|单双/sw|十位/ywdw|一位定位/fs";
