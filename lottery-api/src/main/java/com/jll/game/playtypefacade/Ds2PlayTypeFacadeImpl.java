 ...
 *
 */
public class Ds2PlayTypeFacadeImpl extends DefaultPlayTypeFacadeImpl {
	
	private Logger logger = Logger.getLogger(Ds2PlayTypeFacadeImpl.class);
	
	protected String playTypeDesc = "5ds|单双/dem|第二名/fs";
