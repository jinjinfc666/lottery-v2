 ...
 *
 */
public class Pk10Ds6PlayTypeFacadeImpl extends DefaultPlayTypeFacadeImpl {
	
	private Logger logger = Logger.getLogger(Pk10Ds6PlayTypeFacadeImpl.class);
	
	protected String playTypeDesc = "ds|单双/dlm|第六名/fs";
	...
	public boolean isMatchWinningNum(Issue issue, OrderInfo order) {
		...
		if(Integer.parseInt(winNumSet[5]) % 2 != 0) {
			winNumFinal = ODD;
		}else {
			winNumFinal = EVEN;
		}
