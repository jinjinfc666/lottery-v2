 ...
 *
 */
public class BwDsPlayTypeFacadeImpl extends DefaultPlayTypeFacadeImpl {
	
	private Logger logger = Logger.getLogger(BwDsPlayTypeFacadeImpl.class);
	
	protected String playTypeDesc = "ds|单双/bw|百位/ywdw|一位定位/fs";
