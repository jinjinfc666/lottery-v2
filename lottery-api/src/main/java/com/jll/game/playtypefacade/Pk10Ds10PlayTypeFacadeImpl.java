 ...
 *
 */
public class Pk10Ds10PlayTypeFacadeImpl extends DefaultPlayTypeFacadeImpl {
	
	private Logger logger = Logger.getLogger(Pk10Ds10PlayTypeFacadeImpl.class);
	
	protected String playTypeDesc = "ds|单双/dshim|第十名/fs";
	...
	public boolean isMatchWinningNum(Issue issue, OrderInfo order) {
		...
		if(Integer.parseInt(winNumSet[9]) % 2 != 0) {
			winNumFinal = ODD;
		}else {
			winNumFinal = EVEN;
		}
