 ...
 *
 */
public class Pk10Ds9PlayTypeFacadeImpl extends DefaultPlayTypeFacadeImpl {
	
	private Logger logger = Logger.getLogger(Pk10Ds9PlayTypeFacadeImpl.class);
	
	protected String playTypeDesc = "ds|单双/djm|第九名/fs";
	...
	public boolean isMatchWinningNum(Issue issue, OrderInfo order) {
		...
		if(Integer.parseInt(winNumSet[8]) % 2 != 0) {
			winNumFinal = ODD;
		}else {
			winNumFinal = EVEN;
		}
