 ...
 *
 */
public class Pk10Ds7PlayTypeFacadeImpl extends DefaultPlayTypeFacadeImpl {
	
	private Logger logger = Logger.getLogger(Pk10Ds7PlayTypeFacadeImpl.class);
	
	protected String playTypeDesc = "ds|单双/dqm|第七名/fs";
	...
	public boolean isMatchWinningNum(Issue issue, OrderInfo order) {
		...
		if(Integer.parseInt(winNumSet[6]) % 2 != 0) {
			winNumFinal = ODD;
		}else {
			winNumFinal = EVEN;
		}
