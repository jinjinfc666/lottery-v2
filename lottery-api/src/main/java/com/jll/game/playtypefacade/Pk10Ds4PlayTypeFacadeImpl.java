 ...
 *
 */
public class Pk10Ds4PlayTypeFacadeImpl extends DefaultPlayTypeFacadeImpl {
	
	private Logger logger = Logger.getLogger(Pk10Ds4PlayTypeFacadeImpl.class);
	
	protected String playTypeDesc = "ds|单双/dsim|第四名/fs";
