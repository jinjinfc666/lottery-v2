 ...
 *
 */
public class Ds3PlayTypeFacadeImpl extends DefaultPlayTypeFacadeImpl {
	
	private Logger logger = Logger.getLogger(Ds3PlayTypeFacadeImpl.class);
	
	protected String playTypeDesc = "5ds|单双/dsm|第三名/fs";
