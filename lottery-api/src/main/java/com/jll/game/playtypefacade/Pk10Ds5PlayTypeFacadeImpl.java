 ...
 *
 */
public class Pk10Ds5PlayTypeFacadeImpl extends DefaultPlayTypeFacadeImpl {
	
	private Logger logger = Logger.getLogger(Pk10Ds5PlayTypeFacadeImpl.class);
	
	protected String playTypeDesc = "ds|单双/dwm|第五名/fs";
