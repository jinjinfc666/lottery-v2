 ...
 *
 */
public class Ds1PlayTypeFacadeImpl extends DefaultPlayTypeFacadeImpl {
	
	private Logger logger = Logger.getLogger(Ds1PlayTypeFacadeImpl.class);
	
	protected String playTypeDesc = "5ds|单双/dym|第一名/fs";
