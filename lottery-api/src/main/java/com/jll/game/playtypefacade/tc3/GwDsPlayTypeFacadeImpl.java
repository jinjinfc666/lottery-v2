 ...
 *
 */
public class GwDsPlayTypeFacadeImpl extends DefaultPlayTypeFacadeImpl {
	
	private Logger logger = Logger.getLogger(GwDsPlayTypeFacadeImpl.class);
	
	protected String playTypeDesc = "ds|单双/gw|个位/ywdw|一位定位/fs";
