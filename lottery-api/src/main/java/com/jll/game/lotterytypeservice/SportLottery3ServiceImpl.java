...
//@Service
//@Transactional
public class SportLottery3ServiceImpl extends DefaultLottoTypeServiceImpl
{
	private Logger logger = Logger.getLogger(SportLottery3ServiceImpl.class);

	private final String lotteryType = "tc3";
	...
	public List<Issue> makeAPlan() {		
		...
		GenSequence seq = seqServ.queryTC3DSeqVal();
