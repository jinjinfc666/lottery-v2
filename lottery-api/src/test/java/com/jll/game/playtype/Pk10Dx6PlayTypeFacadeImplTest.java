...
public class Pk10Dx6PlayTypeFacadeImplTest extends ServiceJunitBase{
		
	public Pk10Dx6PlayTypeFacadeImplTest(String name) {
		super(name);
	}	
	...
	final String facadeName = "dx|大小/dlm|第六名/fs";
	...
	public void testIsMatchWinningNum_winning(){
		...
		betNum = "00";
		issue = new Issue();
		issue.setRetNum("06,09,03,10,01,04,08,05,02,07");
	...
	public void testCalPrize(){
		...
		String winningNum = "06,09,03,10,01,04,08,05,02,07";
		String betNum = "00";
		...
		winningNum = "06,09,03,10,01,04,08,05,02,07";
		betNum = "01";		
		issue = new Issue();
		issue.setRetNum(winningNum);
