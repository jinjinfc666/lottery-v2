...
public class Pk10Dx8PlayTypeFacadeImplTest extends ServiceJunitBase{
		
	public Pk10Dx8PlayTypeFacadeImplTest(String name) {
		super(name);
	}	
	...
	final String facadeName = "dx|大小/dbm|第八名/fs";
