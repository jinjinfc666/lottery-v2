...
public class Pk10Dx10PlayTypeFacadeImplTest extends ServiceJunitBase{
		
	public Pk10Dx10PlayTypeFacadeImplTest(String name) {
		super(name);
	}	
	...
	final String facadeName = "dx|大小/dshim|第十名/fs";
