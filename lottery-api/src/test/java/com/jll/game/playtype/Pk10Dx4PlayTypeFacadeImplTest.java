...
public class Pk10Dx4PlayTypeFacadeImplTest extends ServiceJunitBase{
		
	public Pk10Dx4PlayTypeFacadeImplTest(String name) {
		super(name);
	}	
	...
	final String facadeName = "dx|大小/dsim|第四名/fs";
