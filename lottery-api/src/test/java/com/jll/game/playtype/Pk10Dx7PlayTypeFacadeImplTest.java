...
public class Pk10Dx7PlayTypeFacadeImplTest extends ServiceJunitBase{
		
	public Pk10Dx7PlayTypeFacadeImplTest(String name) {
		super(name);
	}	
	...
	final String facadeName = "dx|大小/dqm|第七名/fs";
