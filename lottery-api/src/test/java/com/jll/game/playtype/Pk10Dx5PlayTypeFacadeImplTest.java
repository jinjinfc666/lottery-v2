...
public class Pk10Dx5PlayTypeFacadeImplTest extends ServiceJunitBase{
		
	public Pk10Dx5PlayTypeFacadeImplTest(String name) {
		super(name);
	}	
	...
	final String facadeName = "dx|大小/dwm|第五名/fs";
