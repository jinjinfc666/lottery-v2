...
public class Pk10Ds4PlayTypeFacadeImplTest extends ServiceJunitBase{
		
	public Pk10Ds4PlayTypeFacadeImplTest(String name) {
		super(name);
	}	
	...
	final String facadeName = "ds|单双/dsim|第四名/fs";
	...
	public void testIsMatchWinningNum_winning(){
		...
		issue.setRetNum("06,07,09,08,10,01,02,04,03,05");
