...
public class EwhsSgDsPlayTypeFacadeImplTest extends ServiceJunitBase{
		
	public EwhsSgDsPlayTypeFacadeImplTest(String name) {
		super(name);
	}	
	...
	final String facadeName = "ds|单双/sg|十个/ewhs|二位和数/fs";
	...
	public void testIsMatchWinningNum_lose_01(){
		Date startTime = new Date();
		String betNum = "01";
		Issue issue = new Issue();
		issue.setIssueNum("");
