...
public class Kd4kPlayTypeFacadeImplTest extends ServiceJunitBase{
		
	public Kd4kPlayTypeFacadeImplTest(String name) {
		super(name);
	}	
	...
	final String facadeName = "4k|4跨/kd|跨度/fs";
	...
	public void testValidBetNum_valid_004(){
		String betNum = "004";
	...
	public void testValidBetNum_invalid_0004(){
		String betNum = "0004";
		OrderInfo order = new OrderInfo();
		//order.setIssueId(issueId);
		order.setBetNum(betNum);
	...
	public void testIsMatchWinningNum_winning_004(){
		Date startTime = new Date();
		String betNum = "004";
		Issue issue = new Issue();
		issue.setIssueNum("");
		issue.setLotteryType(Constants.LottoType.TC3.getCode());
		issue.setRetNum("1,2,5");
	...
	public void testIsMatchWinningNum_lost_004(){
		Date startTime = new Date();
		String betNum = "004";
		Issue issue = new Issue();
		issue.setIssueNum("");
	...
	public void testIsMatchWinningNum_win_004_569(){
		Date startTime = new Date();
		String betNum = "004";
		Issue issue = new Issue();
		issue.setIssueNum("");
		issue.setLotteryType(Constants.LottoType.TC3.getCode());
		issue.setRetNum("5,6,9");
		issue.setStartTime(startTime);
		issue.setState(Constants.IssueState.LOTTO_DARW.getCode());
		issue.setEndTime(DateUtil.addMinutes(startTime, 10));
	...
	public void testCalPrize_lost_004(){
	...
	public void testCalPrize_win_004(){
		UserInfo user = new UserInfo();
		user.setId(4);
		user.setUserName("xy_user_001");
		Date startTime = new Date();
	...
	public void testCalPrize_win_004_135(){
		UserInfo user = new UserInfo();
		user.setId(4);
		user.setUserName("xy_user_001");
		Date startTime = new Date();
