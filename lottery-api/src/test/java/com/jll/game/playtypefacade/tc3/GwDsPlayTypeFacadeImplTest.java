...
public class GwDsPlayTypeFacadeImplTest extends ServiceJunitBase{
		
	public GwDsPlayTypeFacadeImplTest(String name) {
		super(name);
	}	
	...
	final String facadeName = "ds|单双/gw|个位/ywdw|一位定位/fs";
	...
	public void testCalPrize_lost_00(){
		UserInfo user = new UserInfo();
		user.setId(4);
		user.setUserName("xy_user_001");
		Date startTime = new Date();
	...
	public void testCalPrize_win_00(){
		UserInfo user = new UserInfo();
		user.setId(4);
		user.setUserName("xy_user_001");
		Date startTime = new Date();
