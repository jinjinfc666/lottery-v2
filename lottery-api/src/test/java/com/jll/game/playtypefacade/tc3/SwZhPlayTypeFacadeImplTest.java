...
public class SwZhPlayTypeFacadeImplTest extends ServiceJunitBase{
		
	public SwZhPlayTypeFacadeImplTest(String name) {
		super(name);
	}	
	...
	final String facadeName = "zh|质和/sw|十位/ywdw|一位定位/fs";
