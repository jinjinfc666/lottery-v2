...
public class ZxZl4mPlayTypeFacadeImplTest extends ServiceJunitBase{
		
	public ZxZl4mPlayTypeFacadeImplTest(String name) {
		super(name);
	}	
	...
	final String facadeName = "4m|4码/zx6|组选6/zx|组选/fs";
	...
	public void testValidBetNum_valid_0123(){
		String betNum = "0123";
	...
	public void testValidBetNum_valid_6789(){
		String betNum = "6789";
		OrderInfo order = new OrderInfo();
		//order.setIssueId(issueId);
		order.setBetNum(betNum);
	...
	public void testIsMatchWinningNum_winning_0123(){
	...
	public void testIsMatchWinningNum_winning_6789(){
		Date startTime = new Date();
		String betNum = "6789";
		Issue issue = new Issue();
		issue.setIssueNum("");
	...
	public void testIsMatchWinningNum_lost_0123(){
		Date startTime = new Date();
		String betNum = "0123";
		Issue issue = new Issue();
		issue.setIssueNum("");
	...
	public void testIsMatchWinningNum_lost_6789(){
		Date startTime = new Date();
		String betNum = "6789";
		Issue issue = new Issue();
		issue.setIssueNum("");
	...
	public void testCalPrize_lost_0123(){
	...
	public void testCalPrize_lost_0123_non_zl(){
		UserInfo user = new UserInfo();
		user.setId(4);
		user.setUserName("xy_user_001");
		Date startTime = new Date();
	...
	public void testCalPrize_win_0123(){
		UserInfo user = new UserInfo();
		user.setId(4);
		user.setUserName("xy_user_001");
		Date startTime = new Date();
