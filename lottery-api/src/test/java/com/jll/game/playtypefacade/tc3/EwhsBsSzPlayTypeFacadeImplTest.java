...
public class EwhsBsSzPlayTypeFacadeImplTest extends ServiceJunitBase{
		
	public EwhsBsSzPlayTypeFacadeImplTest(String name) {
		super(name);
	}	
	...
	final String facadeName = "sz|数值/bs|百十/ewhs|二位和数/fs";
