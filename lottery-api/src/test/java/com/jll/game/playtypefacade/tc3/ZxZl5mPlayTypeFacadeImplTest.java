...
public class ZxZl5mPlayTypeFacadeImplTest extends ServiceJunitBase{
		
	public ZxZl5mPlayTypeFacadeImplTest(String name) {
		super(name);
	}	
	...
	final String facadeName = "5m|5码/zx6|组选6/zx|组选/fs";
	...
	public void testCalPrize_lost_01234_non_zl(){
		UserInfo user = new UserInfo();
		user.setId(4);
		user.setUserName("xy_user_001");
		Date startTime = new Date();
