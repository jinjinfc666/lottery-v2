...
public class ZxZs8mPlayTypeFacadeImplTest extends ServiceJunitBase{
		
	public ZxZs8mPlayTypeFacadeImplTest(String name) {
		super(name);
	}	
	...
	final String facadeName = "8m|8码/zx3|组选3/zx|组选/fs";
	...
	public void testCalPrize_lost_01234567_non_zs(){
		UserInfo user = new UserInfo();
		user.setId(4);
		user.setUserName("xy_user_001");
		Date startTime = new Date();
