...
public class SwhsDxPlayTypeFacadeImplTest extends ServiceJunitBase{
		
	public SwhsDxPlayTypeFacadeImplTest(String name) {
		super(name);
	}	
	...
	final String facadeName = "dx|大小/swhs|三位和数/fs";
