...
public class BwZhPlayTypeFacadeImplTest extends ServiceJunitBase{
		
	public BwZhPlayTypeFacadeImplTest(String name) {
		super(name);
	}	
	...
	final String facadeName = "zh|质和/bw|百位/ywdw|一位定位/fs";
