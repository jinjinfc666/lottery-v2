...
public class Kd3kPlayTypeFacadeImplTest extends ServiceJunitBase{
		
	public Kd3kPlayTypeFacadeImplTest(String name) {
		super(name);
	}	
	...
	final String facadeName = "3k|3跨/kd|跨度/fs";
	...
	public void testValidBetNum_valid_003(){
		String betNum = "003";
	...
	public void testValidBetNum_invalid_0003(){
		String betNum = "0003";
		OrderInfo order = new OrderInfo();
		//order.setIssueId(issueId);
		order.setBetNum(betNum);
	...
	public void testIsMatchWinningNum_winning_003(){
	...
	public void testIsMatchWinningNum_lost_003(){
		Date startTime = new Date();
		String betNum = "003";
		Issue issue = new Issue();
		issue.setIssueNum("");
	...
	public void testIsMatchWinningNum_win_003_568(){
		Date startTime = new Date();
		String betNum = "003";
		Issue issue = new Issue();
		issue.setIssueNum("");
		issue.setLotteryType(Constants.LottoType.TC3.getCode());
		issue.setRetNum("5,6,8");
		issue.setStartTime(startTime);
		issue.setState(Constants.IssueState.LOTTO_DARW.getCode());
		issue.setEndTime(DateUtil.addMinutes(startTime, 10));
	...
	public void testCalPrize_lost_003(){
	...
	public void testCalPrize_win_003(){
		UserInfo user = new UserInfo();
		user.setId(4);
		user.setUserName("xy_user_001");
		Date startTime = new Date();
	...
	public void testCalPrize_win_003_235(){
		UserInfo user = new UserInfo();
		user.setId(4);
		user.setUserName("xy_user_001");
		Date startTime = new Date();
