...
public class EwDwBsSZPlayTypeFacadeImplTest extends ServiceJunitBase{
		
	public EwDwBsSZPlayTypeFacadeImplTest(String name) {
		super(name);
	}	
	...
	final String facadeName = "sz|数值/bs|百十/ewdw|二位定位/fs";
	...
	public void testIsMatchWinningNum_lost_01x(){
		Date startTime = new Date();
		String betNum = "01x";
		Issue issue = new Issue();
		issue.setIssueNum("");
	...
	public void testCalPrize_lost_01x(){
	...
	public void testCalPrize_win_01x(){
		UserInfo user = new UserInfo();
		user.setId(4);
		user.setUserName("xy_user_001");
		Date startTime = new Date();
