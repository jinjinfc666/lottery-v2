...
public class BdwEwPlayTypeFacadeImplTest extends ServiceJunitBase{
		
	public BdwEwPlayTypeFacadeImplTest(String name) {
		super(name);
	}	
	...
	final String facadeName = "sz|数值/ew|二位/bdw|不定位/fs";
