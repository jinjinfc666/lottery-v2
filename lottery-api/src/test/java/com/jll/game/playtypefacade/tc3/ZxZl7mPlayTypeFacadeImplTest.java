...
public class ZxZl7mPlayTypeFacadeImplTest extends ServiceJunitBase{
		
	public ZxZl7mPlayTypeFacadeImplTest(String name) {
		super(name);
	}	
	...
	final String facadeName = "7m|7码/zx6|组选6/zx|组选/fs";
	...
	public void testValidBetNum_valid_0123456(){
		String betNum = "0123456";
	...
	public void testValidBetNum_valid_3456789(){
		String betNum = "3456789";
		OrderInfo order = new OrderInfo();
		//order.setIssueId(issueId);
		order.setBetNum(betNum);
	...
	public void testIsMatchWinningNum_winning_0123456(){
	...
	public void testIsMatchWinningNum_winning_3456789(){
		Date startTime = new Date();
		String betNum = "3456789";
		Issue issue = new Issue();
		issue.setIssueNum("");
	...
	public void testIsMatchWinningNum_lost_0123456(){
		Date startTime = new Date();
		String betNum = "0123456";
		Issue issue = new Issue();
		issue.setIssueNum("");
	...
	public void testIsMatchWinningNum_lost_3456789(){
		Date startTime = new Date();
		String betNum = "3456789";
		Issue issue = new Issue();
		issue.setIssueNum("");
	...
	public void testCalPrize_lost_0123456(){
	...
	public void testCalPrize_lost_0123456_non_zl(){
		UserInfo user = new UserInfo();
		user.setId(4);
		user.setUserName("xy_user_001");
		Date startTime = new Date();
	...
	public void testCalPrize_win_0123456(){
		UserInfo user = new UserInfo();
		user.setId(4);
		user.setUserName("xy_user_001");
		Date startTime = new Date();
