...
public class ZxZl8mPlayTypeFacadeImplTest extends ServiceJunitBase{
		
	public ZxZl8mPlayTypeFacadeImplTest(String name) {
		super(name);
	}	
	...
	final String facadeName = "8m|8码/zx6|组选6/zx|组选/fs";
	...
	public void testValidBetNum_valid_01234567(){
		String betNum = "01234567";
	...
	public void testValidBetNum_valid_23456789(){
		String betNum = "23456789";
		OrderInfo order = new OrderInfo();
		//order.setIssueId(issueId);
		order.setBetNum(betNum);
	...
	public void testIsMatchWinningNum_winning_01234567(){
	...
	public void testIsMatchWinningNum_winning_23456789(){
		Date startTime = new Date();
		String betNum = "23456789";
		Issue issue = new Issue();
		issue.setIssueNum("");
		issue.setLotteryType(Constants.LottoType.TC3.getCode());
		issue.setRetNum("6,7,8");
		issue.setStartTime(startTime);
		issue.setState(Constants.IssueState.LOTTO_DARW.getCode());
		issue.setEndTime(DateUtil.addMinutes(startTime, 10));
	...
	public void testIsMatchWinningNum_lost_01234567(){
		Date startTime = new Date();
		String betNum = "01234567";
		Issue issue = new Issue();
		issue.setIssueNum("");
		issue.setLotteryType(Constants.LottoType.TC3.getCode());
		issue.setRetNum("1,2,9");
		issue.setStartTime(startTime);
		issue.setState(Constants.IssueState.LOTTO_DARW.getCode());
		issue.setEndTime(DateUtil.addMinutes(startTime, 10));
	...
	public void testIsMatchWinningNum_lost_23456789(){
		Date startTime = new Date();
		String betNum = "23456789";
		Issue issue = new Issue();
		issue.setIssueNum("");
	...
	public void testIsMatchWinningNum_lost_non_zl(){
		Date startTime = new Date();
		String betNum = "23456789";
		Issue issue = new Issue();
		issue.setIssueNum("");
		issue.setLotteryType(Constants.LottoType.TC3.getCode());
		issue.setRetNum("7,6,6");
		issue.setStartTime(startTime);
		issue.setState(Constants.IssueState.LOTTO_DARW.getCode());
		issue.setEndTime(DateUtil.addMinutes(startTime, 10));
	...
	public void testCalPrize_lost_01234567(){
	...
	public void testCalPrize_lost_01234567_non_zl(){
		UserInfo user = new UserInfo();
		user.setId(4);
		user.setUserName("xy_user_001");
		Date startTime = new Date();
	...
	public void testCalPrize_win_01234567(){
		UserInfo user = new UserInfo();
		user.setId(4);
		user.setUserName("xy_user_001");
		Date startTime = new Date();
