...
public class ZxZs7mPlayTypeFacadeImplTest extends ServiceJunitBase{
		
	public ZxZs7mPlayTypeFacadeImplTest(String name) {
		super(name);
	}	
	...
	final String facadeName = "7m|7码/zx3|组选3/zx|组选/fs";
	...
	public void testCalPrize_lost_0123456_non_zs(){
		UserInfo user = new UserInfo();
		user.setId(4);
		user.setUserName("xy_user_001");
		Date startTime = new Date();
