...
public class BwSZPlayTypeFacadeImplTest extends ServiceJunitBase{
		
	public BwSZPlayTypeFacadeImplTest(String name) {
		super(name);
	}	
	...
	final String facadeName = "sz|数值/bw|百位/ywdw|一位定位/fs";
