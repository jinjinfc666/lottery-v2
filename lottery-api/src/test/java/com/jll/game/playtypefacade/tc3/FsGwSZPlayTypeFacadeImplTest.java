...
public class FsGwSZPlayTypeFacadeImplTest extends ServiceJunitBase{
		
	public FsGwSZPlayTypeFacadeImplTest(String name) {
		super(name);
	}	
	...
	final String facadeName = "sz|数值/gw|个位/fszh|复式组合/fs";
