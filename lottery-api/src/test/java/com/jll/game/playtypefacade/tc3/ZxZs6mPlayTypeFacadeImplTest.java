...
public class ZxZs6mPlayTypeFacadeImplTest extends ServiceJunitBase{
		
	public ZxZs6mPlayTypeFacadeImplTest(String name) {
		super(name);
	}	
	...
	final String facadeName = "6m|6码/zx3|组选3/zx|组选/fs";
	...
	public void testCalPrize_lost_012345_non_zs(){
		UserInfo user = new UserInfo();
		user.setId(4);
		user.setUserName("xy_user_001");
		Date startTime = new Date();
