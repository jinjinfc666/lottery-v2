...
public class GwSZPlayTypeFacadeImplTest extends ServiceJunitBase{
		
	public GwSZPlayTypeFacadeImplTest(String name) {
		super(name);
	}	
	...
	final String facadeName = "sz|数值/gw|个位/ywdw|一位定位/fs";
	...
	public void testCalPrize_lost_1(){
	...
	public void testCalPrize_win_1(){
		UserInfo user = new UserInfo();
		user.setId(4);
		user.setUserName("xy_user_001");
		Date startTime = new Date();
	...
	public void testCalPrize_lost_0(){
		UserInfo user = new UserInfo();
		user.setId(4);
		user.setUserName("xy_user_001");
		Date startTime = new Date();
	...
	public void testCalPrize_win_0(){
		UserInfo user = new UserInfo();
		user.setId(4);
		user.setUserName("xy_user_001");
		Date startTime = new Date();
