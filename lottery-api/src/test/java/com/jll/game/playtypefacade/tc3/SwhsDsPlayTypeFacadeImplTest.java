...
public class SwhsDsPlayTypeFacadeImplTest extends ServiceJunitBase{
		
	public SwhsDsPlayTypeFacadeImplTest(String name) {
		super(name);
	}	
	...
	final String facadeName = "ds|单双/swhs|三位和数/fs";
