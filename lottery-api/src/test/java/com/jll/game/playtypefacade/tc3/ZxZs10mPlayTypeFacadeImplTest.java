...
public class ZxZs10mPlayTypeFacadeImplTest extends ServiceJunitBase{
		
	public ZxZs10mPlayTypeFacadeImplTest(String name) {
		super(name);
	}	
	...
	final String facadeName = "qb|全包/zx3|组选3/zx|组选/fs";
