...
public class Kd8kPlayTypeFacadeImplTest extends ServiceJunitBase{
		
	public Kd8kPlayTypeFacadeImplTest(String name) {
		super(name);
	}	
	...
	final String facadeName = "8k|8跨/kd|跨度/fs";
	...
	public void testValidBetNum_valid_008(){
		String betNum = "008";
	...
	public void testValidBetNum_invalid_0008(){
		String betNum = "0008";
		OrderInfo order = new OrderInfo();
		//order.setIssueId(issueId);
		order.setBetNum(betNum);
	...
	public void testValidBetNum_invalid_123(){
		String betNum = "123";
		OrderInfo order = new OrderInfo();
		//order.setIssueId(issueId);
		order.setBetNum(betNum);
	...
	public void testIsMatchWinningNum_winning_008(){
	...
	public void testIsMatchWinningNum_lost_008(){
		Date startTime = new Date();
		String betNum = "008";
		Issue issue = new Issue();
		issue.setIssueNum("");
	...
	public void testIsMatchWinningNum_win_008_169(){
		Date startTime = new Date();
		String betNum = "008";
		Issue issue = new Issue();
		issue.setIssueNum("");
		issue.setLotteryType(Constants.LottoType.TC3.getCode());
		issue.setRetNum("1,6,9");
		issue.setStartTime(startTime);
		issue.setState(Constants.IssueState.LOTTO_DARW.getCode());
		issue.setEndTime(DateUtil.addMinutes(startTime, 10));
	...
	public void testCalPrize_lost_008(){
	...
	public void testCalPrize_win_008(){
		UserInfo user = new UserInfo();
		user.setId(4);
		user.setUserName("xy_user_001");
		Date startTime = new Date();
	...
	public void testCalPrize_win_008_139(){
		UserInfo user = new UserInfo();
		user.setId(4);
		user.setUserName("xy_user_001");
		Date startTime = new Date();
