...
public class FsBwSZPlayTypeFacadeImplTest extends ServiceJunitBase{
		
	public FsBwSZPlayTypeFacadeImplTest(String name) {
		super(name);
	}	
	...
	final String facadeName = "sz|数值/bw|百位/fszh|复式组合/fs";
