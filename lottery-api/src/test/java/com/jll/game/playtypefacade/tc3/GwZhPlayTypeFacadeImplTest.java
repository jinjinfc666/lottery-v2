...
public class GwZhPlayTypeFacadeImplTest extends ServiceJunitBase{
		
	public GwZhPlayTypeFacadeImplTest(String name) {
		super(name);
	}	
	...
	final String facadeName = "zh|质和/gw|个位/ywdw|一位定位/fs";
