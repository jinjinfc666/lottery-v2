...
public class EwDwSgSZPlayTypeFacadeImplTest extends ServiceJunitBase{
		
	public EwDwSgSZPlayTypeFacadeImplTest(String name) {
		super(name);
	}	
	...
	final String facadeName = "sz|数值/sg|十个/ewdw|二位定位/fs";
	...
	public void testIsMatchWinningNum_winning_x00(){
	...
	public void testIsMatchWinningNum_winning_99(){
		Date startTime = new Date();
		String betNum = "x99";
		Issue issue = new Issue();
		issue.setIssueNum("");
	...
	public void testIsMatchWinningNum_lost_x01(){
		Date startTime = new Date();
		String betNum = "x01";
		Issue issue = new Issue();
		issue.setIssueNum("");
	...
	public void testCalPrize_lost_x01(){
	...
	public void testCalPrize_win_x01(){
		UserInfo user = new UserInfo();
		user.setId(4);
		user.setUserName("xy_user_001");
		Date startTime = new Date();
