...
public class ZxZs9mPlayTypeFacadeImplTest extends ServiceJunitBase{
		
	public ZxZs9mPlayTypeFacadeImplTest(String name) {
		super(name);
	}	
	...
	final String facadeName = "9m|9码/zx3|组选3/zx|组选/fs";
	...
	public void testValidBetNum_valid_012345678(){
	...
	public void testValidBetNum_valid_123456789(){
		String betNum = "123456789";
		OrderInfo order = new OrderInfo();
		//order.setIssueId(issueId);
		order.setBetNum(betNum);
	...
	public void testIsMatchWinningNum_winning_012345678(){
	...
	public void testIsMatchWinningNum_winning_123456789(){
		Date startTime = new Date();
		String betNum = "123456789";
		Issue issue = new Issue();
		issue.setIssueNum("");
	...
	public void testIsMatchWinningNum_lost_012345678(){
		Date startTime = new Date();
		String betNum = "012345678";
		Issue issue = new Issue();
		issue.setIssueNum("");
	...
	public void testIsMatchWinningNum_lost_123456789(){
		Date startTime = new Date();
		String betNum = "123456789";
		Issue issue = new Issue();
		issue.setIssueNum("");
	...
	public void testCalPrize_lost_012345678(){
	...
	public void testCalPrize_lost_012345678_non_zs(){
		UserInfo user = new UserInfo();
		user.setId(4);
		user.setUserName("xy_user_001");
		Date startTime = new Date();
	...
	public void testCalPrize_win_012345678(){
		UserInfo user = new UserInfo();
		user.setId(4);
		user.setUserName("xy_user_001");
		Date startTime = new Date();
