...
public class EwhsBgSzPlayTypeFacadeImplTest extends ServiceJunitBase{
		
	public EwhsBgSzPlayTypeFacadeImplTest(String name) {
		super(name);
	}	
	...
	final String facadeName = "sz|数值/bg|百个/ewhs|二位和数/fs";
	...
	public void testCalPrize_lost_0_4(){
	...
	public void testCalPrize_win_0_4(){
		UserInfo user = new UserInfo();
		user.setId(4);
		user.setUserName("xy_user_001");
		Date startTime = new Date();
