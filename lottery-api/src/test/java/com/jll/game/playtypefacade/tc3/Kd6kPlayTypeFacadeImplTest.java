...
public class Kd6kPlayTypeFacadeImplTest extends ServiceJunitBase{
		
	public Kd6kPlayTypeFacadeImplTest(String name) {
		super(name);
	}	
	...
	final String facadeName = "6k|6跨/kd|跨度/fs";
	...
	public void testValidBetNum_valid_006(){
		String betNum = "006";
	...
	public void testValidBetNum_invalid_0006(){
		String betNum = "0006";
		OrderInfo order = new OrderInfo();
		//order.setIssueId(issueId);
		order.setBetNum(betNum);
	...
	public void testIsMatchWinningNum_winning_006(){
	...
	public void testIsMatchWinningNum_lost_006(){
		Date startTime = new Date();
		String betNum = "006";
		Issue issue = new Issue();
		issue.setIssueNum("");
	...
	public void testIsMatchWinningNum_win_006_268(){
		Date startTime = new Date();
		String betNum = "006";
		Issue issue = new Issue();
		issue.setIssueNum("");
		issue.setLotteryType(Constants.LottoType.TC3.getCode());
		issue.setRetNum("2,6,8");
		issue.setStartTime(startTime);
		issue.setState(Constants.IssueState.LOTTO_DARW.getCode());
		issue.setEndTime(DateUtil.addMinutes(startTime, 10));
	...
	public void testCalPrize_lost_006(){
	...
	public void testCalPrize_win_006(){
		UserInfo user = new UserInfo();
		user.setId(4);
		user.setUserName("xy_user_001");
		Date startTime = new Date();
	...
	public void testCalPrize_win_006_238(){
		UserInfo user = new UserInfo();
		user.setId(4);
		user.setUserName("xy_user_001");
		Date startTime = new Date();
