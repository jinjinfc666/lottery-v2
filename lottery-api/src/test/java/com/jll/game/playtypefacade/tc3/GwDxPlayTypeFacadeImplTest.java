...
public class GwDxPlayTypeFacadeImplTest extends ServiceJunitBase{
		
	public GwDxPlayTypeFacadeImplTest(String name) {
		super(name);
	}	
	...
	final String facadeName = "dx|大小/gw|个位/ywdw|一位定位/fs";
