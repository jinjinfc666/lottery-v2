...
public class Kd7kPlayTypeFacadeImplTest extends ServiceJunitBase{
		
	public Kd7kPlayTypeFacadeImplTest(String name) {
		super(name);
	}	
	...
	final String facadeName = "7k|7跨/kd|跨度/fs";
	...
	public void testValidBetNum_valid_007(){
		String betNum = "007";
	...
	public void testValidBetNum_invalid_0007(){
		String betNum = "0007";
		OrderInfo order = new OrderInfo();
		//order.setIssueId(issueId);
		order.setBetNum(betNum);
	...
	public void testIsMatchWinningNum_winning_007(){
		Date startTime = new Date();
		String betNum = "007";
		Issue issue = new Issue();
		issue.setIssueNum("");
		issue.setLotteryType(Constants.LottoType.TC3.getCode());
		issue.setRetNum("1,2,8");
	...
	public void testIsMatchWinningNum_lost_007(){
		Date startTime = new Date();
		String betNum = "007";
		Issue issue = new Issue();
		issue.setIssueNum("");
	...
	public void testIsMatchWinningNum_win_007_168(){
		Date startTime = new Date();
		String betNum = "007";
		Issue issue = new Issue();
		issue.setIssueNum("");
		issue.setLotteryType(Constants.LottoType.TC3.getCode());
		issue.setRetNum("1,6,8");
		issue.setStartTime(startTime);
		issue.setState(Constants.IssueState.LOTTO_DARW.getCode());
		issue.setEndTime(DateUtil.addMinutes(startTime, 10));
	...
	public void testCalPrize_lost_007(){
	...
	public void testCalPrize_win_007(){
		UserInfo user = new UserInfo();
		user.setId(4);
		user.setUserName("xy_user_001");
		Date startTime = new Date();
	...
	public void testCalPrize_win_007_138(){
		UserInfo user = new UserInfo();
		user.setId(4);
		user.setUserName("xy_user_001");
		Date startTime = new Date();
