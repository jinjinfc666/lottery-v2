...
public class EwhsBsDsPlayTypeFacadeImplTest extends ServiceJunitBase{
		
	public EwhsBsDsPlayTypeFacadeImplTest(String name) {
		super(name);
	}	
	...
	final String facadeName = "ds|单双/bs|百十/ewhs|二位和数/fs";
