...
public class SwSZPlayTypeFacadeImplTest extends ServiceJunitBase{
		
	public SwSZPlayTypeFacadeImplTest(String name) {
		super(name);
	}	
	...
	final String facadeName = "sz|数值/sw|十位/ywdw|一位定位/fs";
