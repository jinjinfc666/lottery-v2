...
public class SwDwSZPlayTypeFacadeImplTest extends ServiceJunitBase{
		
	public SwDwSZPlayTypeFacadeImplTest(String name) {
		super(name);
	}	
	...
	final String facadeName = "sz|数值/swdw|三位定位/fs";
	...
	public void testIsMatchWinningNum_winning_012(){
	...
	public void testIsMatchWinningNum_winning_999(){
		Date startTime = new Date();
		String betNum = "999";
		Issue issue = new Issue();
		issue.setIssueNum("");
		issue.setLotteryType(Constants.LottoType.TC3.getCode());
		issue.setRetNum("9,9,9");
		issue.setStartTime(startTime);
		issue.setState(Constants.IssueState.LOTTO_DARW.getCode());
		issue.setEndTime(DateUtil.addMinutes(startTime, 10));
	...
	public void testIsMatchWinningNum_lost_999(){
		Date startTime = new Date();
		String betNum = "999";
		Issue issue = new Issue();
		issue.setIssueNum("");
	...
	public void testCalPrize_lost_999(){
	...
	public void testCalPrize_win_999(){
		UserInfo user = new UserInfo();
		user.setId(4);
		user.setUserName("xy_user_001");
		Date startTime = new Date();
