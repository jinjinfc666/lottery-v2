...
public class ZxZl6mPlayTypeFacadeImplTest extends ServiceJunitBase{
		
	public ZxZl6mPlayTypeFacadeImplTest(String name) {
		super(name);
	}	
	...
	final String facadeName = "6m|6码/zx6|组选6/zx|组选/fs";
	...
	public void testValidBetNum_valid_012345(){
	...
	public void testValidBetNum_valid_456789(){
		String betNum = "456789";
		OrderInfo order = new OrderInfo();
		//order.setIssueId(issueId);
		order.setBetNum(betNum);
	...
	public void testIsMatchWinningNum_winning_012345(){
	...
	public void testIsMatchWinningNum_winning_456789(){
		Date startTime = new Date();
		String betNum = "456789";
		Issue issue = new Issue();
		issue.setIssueNum("");
	...
	public void testIsMatchWinningNum_lost_012345(){
		Date startTime = new Date();
		String betNum = "012345";
		Issue issue = new Issue();
		issue.setIssueNum("");
	...
	public void testIsMatchWinningNum_lost_456789(){
		Date startTime = new Date();
		String betNum = "456789";
		Issue issue = new Issue();
		issue.setIssueNum("");
	...
	public void testCalPrize_lost_012345(){
	...
	public void testCalPrize_lost_012345_non_zl(){
		UserInfo user = new UserInfo();
		user.setId(4);
		user.setUserName("xy_user_001");
		Date startTime = new Date();
	...
	public void testCalPrize_win_012345(){
		UserInfo user = new UserInfo();
		user.setId(4);
		user.setUserName("xy_user_001");
		Date startTime = new Date();
