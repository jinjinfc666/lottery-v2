...
public class Kd1kPlayTypeFacadeImplTest extends ServiceJunitBase{
	...
	public void testValidBetNum_ivalid_000(){
		String betNum = "000";
	...
	public void testIsMatchWinningNum_win_001_122(){
		Date startTime = new Date();
		String betNum = "001";
		Issue issue = new Issue();
		issue.setIssueNum("");
	...
	public void testCalPrize_lost_001(){
	...
	public void testCalPrize_win_001(){
		UserInfo user = new UserInfo();
		user.setId(4);
		user.setUserName("xy_user_001");
		Date startTime = new Date();
	...
	public void testCalPrize_win_001_122(){
		UserInfo user = new UserInfo();
		user.setId(4);
		user.setUserName("xy_user_001");
		Date startTime = new Date();
