...
public class Kd2kPlayTypeFacadeImplTest extends ServiceJunitBase{
	...
	public void testValidBetNum_valid_779(){
		String betNum = "779";
		OrderInfo order = new OrderInfo();
		//order.setIssueId(issueId);
		order.setBetNum(betNum);
	...
	public void testValidBetNum_valid_124(){
		String betNum = "124";
		OrderInfo order = new OrderInfo();
		//order.setIssueId(issueId);
		order.setBetNum(betNum);
	...
	public void testIsMatchWinningNum_winning_779(){
		Date startTime = new Date();
		String betNum = "779";
		Issue issue = new Issue();
		issue.setIssueNum("");
		issue.setLotteryType(Constants.LottoType.TC3.getCode());
		issue.setRetNum("7,7,9");
		issue.setStartTime(startTime);
		issue.setState(Constants.IssueState.LOTTO_DARW.getCode());
		issue.setEndTime(DateUtil.addMinutes(startTime, 10));
	...
	public void testIsMatchWinningNum_lost_779(){
		Date startTime = new Date();
		String betNum = "779";
		Issue issue = new Issue();
		issue.setIssueNum("");
