...
public class Kd2kPlayTypeFacadeImplTest extends ServiceJunitBase{
		
	public Kd2kPlayTypeFacadeImplTest(String name) {
		super(name);
	}	
	...
	final String facadeName = "2k|2跨/kd|跨度/fs";
	...
	public void testValidBetNum_valid_002(){
		String betNum = "002";
	...
	public void testIsMatchWinningNum_winning_002(){
	...
	public void testIsMatchWinningNum_lost_009(){
		Date startTime = new Date();
		String betNum = "009";
		Issue issue = new Issue();
		issue.setIssueNum("");
	...
	public void testIsMatchWinningNum_win_002(){
		Date startTime = new Date();
		String betNum = "002";
		Issue issue = new Issue();
		issue.setIssueNum("");
	...
	public void testIsMatchWinningNum_lost_002(){
		Date startTime = new Date();
		String betNum = "002";
		Issue issue = new Issue();
		issue.setIssueNum("");
	...
	public void testCalPrize_lost_002(){
	...
	public void testCalPrize_win_002(){
		UserInfo user = new UserInfo();
		user.setId(4);
		user.setUserName("xy_user_001");
		Date startTime = new Date();
	...
	public void testCalPrize_win_002_234(){
		UserInfo user = new UserInfo();
		user.setId(4);
		user.setUserName("xy_user_001");
		Date startTime = new Date();
